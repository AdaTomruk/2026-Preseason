...
public class RobotContainer {
    ...
    private void configureSwerveBindings() {
        ...
        joystick.b().whileTrue(
            Commands.defer(() -> {
                // This code now runs ONLY when 'B' is pressed
                return driveToPointCommandFactory.generateCommand(
    ...
    }, java.util.Set.of(drivetrain)) // Require the drivetrain for this deferred command
);
